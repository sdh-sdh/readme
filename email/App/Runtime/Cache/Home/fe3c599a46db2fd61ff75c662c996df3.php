<?php if (!defined('THINK_PATH')) exit();?><!-- <!doctype html> -->
 <!--    <html>
    ...
    <body>
    <center>
    <form action="<?php echo U('sms');?>" method="get">手机号码：
...
<script type="text/javascript" src="/s45-----------------------------/email/Public/js/jquery.js"></script>
<script language="javascript">
	function get_mobile_code(){
        $.post("<?php echo U('Home/Index/sms');?>", {mobile:jQuery.trim($('#mobile').val()),send_code:<?php echo $_SESSION['send_code'];?>}, function(msg) {
