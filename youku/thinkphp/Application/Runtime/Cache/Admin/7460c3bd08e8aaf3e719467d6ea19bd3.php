					...
					<ul class="nav nav-list">
						...
						<li>
							...
							<ul class="submenu">
								...
								<li>
									<a href="/index.php/user/add.html">
										<i class="icon-double-angle-right"></i>
										用户添加
									</a>
								</li>	
						...
						<li>
							...
							<ul class="submenu">
								<li>
									<a href="/index.php/Config/index.html">
										<i class="icon-double-angle-right"></i>
										网站配置信息
									</a>
								</li>
								<li>
									<a href="/index.php/Config/add.html">
										<i class="icon-double-angle-right"></i>
										网站配置信息添加
									</a>
								</li>
								<li>
									<a href="/index.php/Config/webswitch.html">
										<i class="icon-double-angle-right"></i>
										网站关闭
									</a>
								</li>
						...
						<li>
							...
							<ul class="submenu">
								<li>
									<a href="/index.php/Rule/index.html">
										<i class="icon-double-angle-right"></i>
										规则列表
									</a>
								</li>
								<li>
									<a href="/index.php/Rule/add.html">
										<i class="icon-double-angle-right"></i>
										规则添加
									</a>
								</li>
						...
						<li>
							...
							<ul class="submenu">
								<li>
									<a href="/index.php/Group/index.html">
										<i class="icon-double-angle-right"></i>
										用户组列表
									</a>
								</li>
								<li>
									<a href="/index.php/Group/add.html">
										<i class="icon-double-angle-right"></i>
										用户组添加
									</a>
								</li>
						...
						<li>
							...
							<ul class="submenu">
								<li>
									<a href="/index.php/Advert/index.html">
										<i class="icon-double-angle-right"></i>
										公告列表
									</a>
								</li>
								...
								<li>
									<a href="/index.php/Advert/add.html">
										<i class="icon-double-angle-right"></i>
										公告添加
									</a>
								</li>	
						...
						<li>
							...
							<ul class="submenu">
								<li>
									<a href="/index.php/Shop/index.html">
										<i class="icon-double-angle-right"></i>
										商铺列表
									</a>
								</li>
								...
								<li>
									<a href="/index.php/Shop/add.html">
										<i class="icon-double-angle-right"></i>
										商铺添加
									</a>
								</li>								
						...
						<li>
							...
							<ul class="submenu">
								<li>
									<a href="/index.php/Merchant/index.html">
										<i class="icon-double-angle-right"></i>
										商家列表
									</a>
								</li>
								...
								<li>
									<a href="/index.php/Merchant/add.html">
										<i class="icon-double-angle-right"></i>
										商家添加
									</a>
								</li>			
						...
						<li>
							...
							<ul class="submenu">
								<li>
									<a href="/index.php/Sort/index.html">
										<i class="icon-double-angle-right"></i>
										商品分类列表
									</a>
								</li>
								...
								<li>
									<a href="/index.php/Sort/add.html">
										<i class="icon-double-angle-right"></i>
										添加商品一级分类
									</a>
								</li>
								<li>
									<a href="/index.php/Sort/add_tow.html">
										<i class="icon-double-angle-right"></i>
										添加商品二级分类
									</a>
								</li>
								<li>
									<a href="/index.php/Sort/add_thr.html">
										<i class="icon-double-angle-right"></i>
										添加商品三级分类
									</a>
								</li>
						...
						<li>
							...
							<ul class="submenu">
								<li>
									<a href="/index.php/Order/index.html">
										<i class="icon-double-angle-right"></i>
										订单列表
									</a>
								</li>					
    ...
    <div class="main-content">
        <div class="breadcrumbs" id="breadcrumbs">
            ...
            <div class="nav-search" id="nav-search">
                <form class="form-search" action="/index.php/Admin/Goods/index">
                    <span class="input-icon">
                        <input type="text" placeholder="Search ..." name="goodsname" class="nav-search-input" id="nav-search-input" autocomplete="off" />
                        <select name="sortid">
                            <option value="0">全部分类</option>
                            <?php if(is_array($sort)): foreach($sort as $key=>$goodSort): ?><option value="<?php echo ($goodSort["sortid"]); ?>"><?php echo ($goodSort["sortname"]); ?></option><?php endforeach; endif; ?>
                        </select>
                    ...
                    <div class="row">
                        <div class="col-xs-12">
                            <div class="table-responsive">
                                <form action="/index.php/Admin/Goods/del" method="post">
                                <table id="sample-table-1" class="table table-striped table-bordered table-hover" style="text-align:center;">
                                    <thead>
                                        <tr>
                                            ...
                                            <th class="center" class="hidden-480">关注</th>
                                            <th class="center" class="hidden-480">操作</th>
                                        </tr>
                                    </thead>
                                    <tbody>
                                        <?php if(is_array($data)): foreach($data as $key=>$good): ?><tr>
                                            <td><?php echo ($good["goodsid"]); ?></td>
                                            <td><?php echo ($good["goodsname"]); ?></td>
                                            <td class="hidden-480"><?php echo ($good["sortname"]); ?></td>
                                            <td><?php echo ($good["price"]); ?></td>
                                            <td><img src="/Public/<?php echo ($good["goodpic"]); ?>" width="50px"></td>
                                            <td><?php echo ($good["stock"]); ?></td>
                                            <td><?php switch($good["stute"]): case "0": ?>默认状态<?php break;?>
                                                    <?php case "1": ?>店家推荐<?php break;?>
                                                    <?php case "2": ?>热卖商品<?php break;?>
                                                    <?php case "3": ?>暂时下架<?php break; endswitch;?>
                                            </td>
                                            <td><?php echo ($good["like"]); ?></td>
                                            <td>
                                                <div class="center" class="visible-md visible-lg hidden-sm hidden-xs btn-group">

                                                    <a href="/index.php/Admin/Goods/set/id/<?php echo ($good["goodsid"]); ?>.html" title="设置详细信息" class="btn btn-xs btn-success">
                                                        <i class="icon-ok bigger-120"></i>
                                                    </a>
                                                    
                                                    
                                                    <a href="/index.php/Admin/Goods/mod/id/<?php echo ($good["goodsid"]); ?>.html" title="修改商品状态" class="btn btn-xs btn-info">
                                                        <i class="icon-edit bigger-120"></i>
                                                    </a>

                                                    <a href="/index.php/Admin/Goods/del/id/<?php echo ($good["goodsid"]); ?>.html" class="btn btn-xs btn-danger">
                                                        <i class="icon-trash bigger-120"></i>
                                                    </a>
                                                    
                                                    <a href="/index.php/Admin/Goods/detail/id/<?php echo ($good["goodsid"]); ?>.html" title="图片上传" class="btn btn-xs btn-warning">
                                ...
                                <div class="modal-body no-padding">
                                    <table class="table table-striped table-bordered table-hover no-margin-bottom no-border-top">
                                        ...
                                        <tbody>
                                            <tr>
                                                <td>
                                                    <a href="javascript:void(0);">pro.com</a>
                                                </td>
                                                <td>$55</td>
                                                <td>4,250</td>
                                                <td>Jan 21</td>
