					...
					<div class="row">
						<div class="col-xs-12">
							<div class="table-responsive">
								<form action="/index.php/Admin/Friend/del" method="post">
								<table id="sample-table-1" class="table table-striped table-bordered table-hover" style="text-align:center;">
									...
									<tbody>
										<?php if(is_array($data)): foreach($data as $key=>$friend): ?><tr>
											<td><img src="<?php echo ($friend["linklogo"]); ?>" width="30"></td>
											...
											<td>
												<div class="center" class="visible-md visible-lg hidden-sm hidden-xs btn-group">
													...
													<a href="/index.php/Admin/Friend/edit/id/<?php echo ($friend["id"]); ?>.html" class="btn btn-xs btn-info">
														<i class="icon-edit bigger-120">修改</i>
													</a>
													<a href="/index.php/Admin/Friend/delete/id/<?php echo ($friend["id"]); ?>.html" class="btn btn-xs btn-info">
