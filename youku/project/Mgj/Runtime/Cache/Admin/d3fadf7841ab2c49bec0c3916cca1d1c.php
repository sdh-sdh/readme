                    ...
                    <div class="row">
                        <div class="col-xs-12">
                            <div class="table-responsive">
                                <form action="/index.php/Admin/User/update" method="post" enctype="multipart/form-data">
                                <table id="sample-table-1" class="table table-striped table-bordered table-hover">
                                    <tbody>
                                        ...
                                        <tr>
                                            ...
                                            <td><input type="file" name="userpic" value=""><img src="/<?php echo ($info["userpic"]); ?>" id="form-field-1" style="width:200px;" class="col-xs-10 col-sm-5" /></td>
                                        </tr>
                                        <tr>
