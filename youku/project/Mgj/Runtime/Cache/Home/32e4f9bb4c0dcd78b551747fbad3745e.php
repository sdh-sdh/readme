...
<head>
    ...
    <link rel="stylesheet" href="/zhangdi/youku/project/Public/Home/css/info.css">
    <link rel="stylesheet" href="/zhangdi/youku/project/Public/Home/css/orderUser.css">
...
<!-- 头部 logo  搜索-->
        ...
        <div class="row header_bg">
            <div class="col-xs-2 col-xs-offset-1 header_logo">
                <a href="<?php echo U('Home/Index/index');?>" style="line-height: 28px">
                    <img src="/zhangdi/youku/project<?php echo ($config['headlogo']); ?>">
                </a>
            </div>
    ...
    <div class="info">
        ...
        <div class="info_left">
            <!-- 头像、等级 -->
            <div class="left_img">
                <img src="/zhangdi/youku/project/<?php echo ($u['userpic']); ?>" alt="">
                            ...
                            <tr class="d_order_table_item">
                                <td class="d_goods" colspan="2">
                                    <?php if(is_array($orders['mygoods'])): foreach($orders['mygoods'] as $key=>$stor): if(is_array($stor['myattr'])): foreach($stor['myattr'] as $key=>$godatr): ?><a href="" class="d_pic" hidefocus="true" title="" target="_blank"><img
                                                    src="/zhangdi/youku/project<?php echo ($stor['goodpic']); ?>" alt="" width="70"></a>
...
<script src="/zhangdi/youku/project/Public/Home/js/indexs.js"></script>
    ...
    <script src="/zhangdi/youku/project/Public/Home/js/userOrder.js"></script>
    <script>
        //订单倒计时
        $(function ()
        {
