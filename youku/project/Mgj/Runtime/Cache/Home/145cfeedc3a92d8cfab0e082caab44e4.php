...
<head>
	...
	<link rel="icon" href="/zhangdi/youku/project/Public/Home/images/favicon32.ico" type="image/x-icon"/>
    <meta name="copyright" content="<?php echo ($config['content']); ?>"/>
    <link rel="stylesheet" href="/zhangdi/youku/project/Public/Home/css/bootstrap.min.css">
    <link rel="stylesheet" href="/zhangdi/youku/project/Public/Home/css/css.css">
    
    <link rel="stylesheet" href="/zhangdi/youku/project/Public/Home/css/css1.css">
    <link rel="stylesheet" href="/zhangdi/youku/project/Public/Home/css/sort.css">
    <style type="text/css">
        #pages a, #pages span {
    ...
    <div class="shop-header">
        <div class="header clearfix">
            <div class="user-info fl">
                <a href="" class="avatar" title="<?php echo ($shops[0][shopname]); ?>"><img class="face fl" src="/zhangdi/youku/project/<?php echo ($shops[0][userpic]); ?>"></a>
                ...
                <div class="shop-action fl">
                    ...
                    <a href="javascript:;" class="chart fl clearfix" data-ptp-idx="19">
                        <div class="mogutalk_widget_btn kefu fl">
                            <iframe src="/zhangdi/youku/project/Public/Home/image/sl.gif" width="48" height="20" frameborder="0" scrolling="no" marginheight="0" allowtransparency="true"></iframe>
                        </div>
                    </a>
                </div>
        ...
        <div class="mod_list clearfix">
            <div class="mod_item w1200">
                <div class="mod_cont topbanner">
                    <a class="shop_bg_img" href="" style="background: url(/zhangdi/youku/project<?php echo ($shopo[0][shoplogo]); ?>) center no-repeat"></a>
                </div>
            </div>
        </div>
    </div>
            ...
            <div class="col-xs-4">
                <div class="row">
                    <div class="item-pic-origin" style="max-height:550px;">
                        <img width="400" id="dtp" class="j-big-pic twitter_pic" src="/zhangdi/youku/project<?php echo ($goodPic[0][ goodspic]); ?>">
                    </div>
                    <!--<div id="fdj" class="fdj">-->
                        <!--<img src="/zhangdi/youku/project<?php echo ($ginfo["goodpic"]); ?>">-->
                    <!--</div>-->
                </div>
                <div class="row">
                    <div id="js-pic-thumb" class="item-pic-thumb">
                        <?php if(is_array($goodPic)): foreach($goodPic as $key=>$vo): ?><span class="active"><img width="68" height="68" src="/zhangdi/youku/project<?php echo ($vo['goodspic']); ?>"></span><?php endforeach; endif; ?>
                    </div>
                </div>
            </div>
                                ...
                                <div class="shop-name">
                                    <a class="text text-hasim" href="">小四专注时尚潮流款
                                        <div class="mogutalk_widget_btn kefu">
                                            <iframe src="/zhangdi/youku/project/Public/Home/image/sll.gif" width="16" height="17" frameborder="0" scrolling="no" marginheight="0" allowtransparency="true"></iframe>
                                        </div>
                                    </a>
                                </div>
                            </h3>
                            ...
                            <div class="ui-bd">
                                ...
                                <div class="shop-provide">
                                    ...
                                    <a class="pic" href="javascript:;">
                                        <img class="img-lazyload" width="150" height="26" src="/zhangdi/youku/project/Public/Home/image/ben.png">
                                    </a>
                                </div>
                            </div>
                        </div>
                            ...
                            <div id="details" class="panel-box">
                                <div class="module-panel module-graphic">
                                    ...
                                    <div id="J_Graphic_model_img">
                                        ...
                                        <div class="graphic-block">
                                            <?php if(is_array($arg)): foreach($arg as $key=>$v): ?><img class="img-lazyload img-responsive" src="/zhangdi/youku/project<?php echo ($v['dresspic']); ?>" /><?php endforeach; endif; ?>
                                        </div>
                                    </div>
                                </div>
                            </div>
            ...
            <div class="row">
                ...
                <div class="col-xs-2 clear_padding">
                    <div class="f_list qr-code pull-right">
                        <h4>蘑菇街微信服务号</h4>
                        <img src="/zhangdi/youku/project/Public/Home/images/ma.jpg" alt="蘑菇街服务号二维码">
                    </div>
                </div>
                <div class="col-xs-2 clear_padding">
...
<script src="/zhangdi/youku/project/Public/Home/js/bootstrap.min.js"></script>
<script src="/zhangdi/youku/project/Public/Home/js/move.js"></script>
<script src="/zhangdi/youku/project/Public/Home/js/indexs.js"></script>

<script type="text/javascript" src="/zhangdi/youku/project/Public/Home/js/jquery-1.11.3.min.js"></script>
    <script type="text/javascript" src="/zhangdi/youku/project/Public/Home/js/sort.js"></script>
    <script>
        var logut = "<?php echo U('Home/Sorts/loginOut');?>";
        var url = '<?php echo U("Home/Detail/ajaxStock", array("id"=>I("get.id")));?>';
    </script>
    <script src="/zhangdi/youku/project/Public/Home/js/details.js"></script>
